 ...
 * */
public class RandomAccessFileReaderOld extends RandomAccessReaderOld
{
    @NotNull
    ...
    public RandomAccessFileReaderOld(@NotNull RandomAccessFile file) throws IOException
    {
        this(file, 0);
    }
    ...
    @SuppressWarnings({ "ConstantConditions" })
    @com.drew.lang.annotations.SuppressWarnings(value = "EI_EXPOSE_REP2", justification = "Design intent")
    public RandomAccessFileReaderOld(@NotNull RandomAccessFile file, int baseOffset) throws IOException
    {
        if (file == null)
