...
public class SoundMediaInformationHeaderAtom extends FullAtom
{
    int balance;

    public SoundMediaInformationHeaderAtom(SequentialReader reader, Atom atom) throws IOException
    {
        super(reader, atom);
