...
public class QtAtomTypes
{
    ...
    public static final String ATOM_VIDEO_MEDIA_HEADER = "vmhd";
    public static final String ATOM_SOUND_MEDIA_HEADER = "smhd";
    ...
    static {
        ...
        _atomList.add(ATOM_VIDEO_MEDIA_HEADER);
        _atomList.add(ATOM_SOUND_MEDIA_HEADER);
