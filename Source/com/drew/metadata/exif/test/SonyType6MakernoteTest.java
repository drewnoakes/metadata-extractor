...
import com.drew.metadata.exif.SonyType6MakernoteDescriptor;
...
public class SonyType6MakernoteTest
{
    ...
    {
        Metadata metadata = TestHelper.readJpegMetadataFile("Source/com/drew/metadata/exif/test/sonyType6.metadata");
        ...
        Assert.assertEquals("0200", descriptor.getMakerNoteThumbVersionDescription());
    }
}
