...
//                return getLensIDDescription();
    ...
    {
        return getIndexedDescription(SonyType1MakernoteDirectory.TAG_VIGNETTING_CORRECTION, "Off", null, "Auto");
    }

    @Nullable
    public String getLateralChromaticAberrationDescription()
    {
        return getIndexedDescription(SonyType1MakernoteDirectory.TAG_LATERAL_CHROMATIC_ABERRATION, "Off", null, "Auto");
    }
