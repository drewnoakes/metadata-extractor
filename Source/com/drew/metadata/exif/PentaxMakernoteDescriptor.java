...
public class PentaxMakernoteDescriptor extends TagDescriptor<PentaxMakernoteDirectory>
{
    ...
    {
        return getIndexedDescription(PentaxMakernoteDirectory.TAG_WHITE_BALANCE, "Auto", "Daylight", "Shade", "Tungsten", "Fluorescent", "Manual");
    }
...
/*
    ...
    {
        return getByteLengthDescription(PentaxMakernoteDirectory.TAG_PANASONIC_PRINT_IMAGE_MATCHING_INFO);
    }

    public String getMacroModeDescription()
    {
        return getIndexedDescription(PentaxMakernoteDirectory.TAG_PANASONIC_MACRO_MODE, 1, "On", "Off");
    }

    public String getRecordModeDescription()
    {
        return getIndexedDescription(PentaxMakernoteDirectory.TAG_PANASONIC_RECORD_MODE, 1, "Normal", "Portrait", "Macro");
    }
*/
}
