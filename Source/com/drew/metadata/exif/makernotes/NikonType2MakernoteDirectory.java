...
public class NikonType2MakernoteDirectory extends Directory
{
    ...
    private static final int[] decTable1 =   {0xc1,0xbf,0x6d,0x0d,0x59,0xc5,0x13,0x9d,0x83,0x61,0x6b,0x4f,0xc7,0x7f,0x3d,0x3d,
    ...
    private static final int[] decTable2 = { 0xa7,0xbc,0xc9,0xad,0x91,0xdf,0x85,0xe5,0xd4,0x78,0xd5,0x17,0x46,0x7c,0x29,0x4c,
    ...
    public int[] getDecryptedIntArray(int tagType) throws MetadataException
    {
        ...
        int ci = decTable1[serial & 0xff];
        int cj = decTable2[key];
        int ck = 0x60;
