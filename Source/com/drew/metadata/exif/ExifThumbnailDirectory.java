...
public class ExifThumbnailDirectory extends Directory
{
    ...
    public void setThumbnailData(@Nullable final byte[] data)
    {
        _thumbnailData = data;
    }

    public void writeThumbnail(@NotNull final String filename) throws MetadataException, IOException
    {
        final byte[] data = _thumbnailData;
